...
export default function Button({
  ...
  const variants = {
    ...
    success: 'bg-gradient-to-r from-emerald-600 to-emerald-500 hover:from-emerald-500 hover:to-emerald-400 text-white shadow-lg shadow-emerald-600/30 focus:ring-emerald-500',
  }
